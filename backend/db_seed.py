...
with app.app_context():
    ...
    for ingredient_data in ingredients_data:
        existing_ingredient = (
            session.query(Ingredient).filter_by(name=ingredient_data["name"]).first()
        )
    ...
    ingredient_dict = {
        ingredient.name: ingredient.id for ingredient in session.query(Ingredient).all()
    }
    ...
    pizzas_da = [
        ...
        {"name": "Taco Pizza", "price": 11.99, "category": "pizza"},
        {
            ...
            "price": 12.49,
            "category": "pizza",
        },  # Hawaiian without pineapple because it's a crime
    ...
    pizza_ingredients.extend(
        [
            # BBQ Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[0].id, ingredient_id=ingredient_dict["BBQ Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[0].id, ingredient_id=ingredient_dict["Chicken"]
            ),
            PizzaIngredient(
                menu_id=pizzas[0].id, ingredient_id=ingredient_dict["Red Onion"]
            ),
            PizzaIngredient(
                menu_id=pizzas[0].id, ingredient_id=ingredient_dict["Cheddar Cheese"]
            ),
            # Four Cheese Pizza
            PizzaIngredient(
                menu_id=pizzas[1].id, ingredient_id=ingredient_dict["Cheddar Cheese"]
            ),
            PizzaIngredient(
                menu_id=pizzas[1].id, ingredient_id=ingredient_dict["Blue Cheese"]
            ),
            PizzaIngredient(
                menu_id=pizzas[1].id, ingredient_id=ingredient_dict["Mozzarella"]
            ),
            PizzaIngredient(
                menu_id=pizzas[1].id, ingredient_id=ingredient_dict["Feta Cheese"]
            ),
            # Pesto Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[2].id, ingredient_id=ingredient_dict["Pesto"]
            ),
            PizzaIngredient(
                menu_id=pizzas[2].id, ingredient_id=ingredient_dict["Chicken"]
            ),
            PizzaIngredient(
                menu_id=pizzas[2].id, ingredient_id=ingredient_dict["Spinach"]
            ),
            PizzaIngredient(
                menu_id=pizzas[2].id, ingredient_id=ingredient_dict["Mozzarella"]
            ),
            # Buffalo Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[3].id, ingredient_id=ingredient_dict["Buffalo Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[3].id, ingredient_id=ingredient_dict["Chicken"]
            ),
            PizzaIngredient(
                menu_id=pizzas[3].id, ingredient_id=ingredient_dict["Blue Cheese"]
            ),
            PizzaIngredient(
                menu_id=pizzas[3].id, ingredient_id=ingredient_dict["Celery"]
            ),
            # Mediterranean Veggie Pizza
            PizzaIngredient(
                menu_id=pizzas[4].id, ingredient_id=ingredient_dict["Olives"]
            ),
            PizzaIngredient(
                menu_id=pizzas[4].id, ingredient_id=ingredient_dict["Artichokes"]
            ),
            PizzaIngredient(
                menu_id=pizzas[4].id, ingredient_id=ingredient_dict["Spinach"]
            ),
            PizzaIngredient(
                menu_id=pizzas[4].id, ingredient_id=ingredient_dict["Feta Cheese"]
            ),
            # Spinach and Feta Pizza
            PizzaIngredient(
                menu_id=pizzas[5].id, ingredient_id=ingredient_dict["Spinach"]
            ),
            PizzaIngredient(
                menu_id=pizzas[5].id, ingredient_id=ingredient_dict["Feta Cheese"]
            ),
            PizzaIngredient(
                menu_id=pizzas[5].id, ingredient_id=ingredient_dict["Tomato Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[5].id, ingredient_id=ingredient_dict["Mozzarella"]
            ),
            # Chicken Alfredo Pizza
            PizzaIngredient(
                menu_id=pizzas[6].id, ingredient_id=ingredient_dict["Alfredo Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[6].id, ingredient_id=ingredient_dict["Chicken"]
            ),
            PizzaIngredient(
                menu_id=pizzas[6].id, ingredient_id=ingredient_dict["Cheddar Cheese"]
            ),
            # Seafood Pizza
            PizzaIngredient(
                menu_id=pizzas[7].id, ingredient_id=ingredient_dict["Shrimp"]
            ),
            PizzaIngredient(
                menu_id=pizzas[7].id, ingredient_id=ingredient_dict["Crab"]
            ),
            PizzaIngredient(
                menu_id=pizzas[7].id, ingredient_id=ingredient_dict["Garlic"]
            ),
            PizzaIngredient(
                menu_id=pizzas[7].id, ingredient_id=ingredient_dict["Tomato Sauce"]
            ),
            # Thai Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[8].id, ingredient_id=ingredient_dict["Chicken"]
            ),
            PizzaIngredient(
                menu_id=pizzas[8].id, ingredient_id=ingredient_dict["Peanut Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[8].id, ingredient_id=ingredient_dict["Cilantro"]
            ),
            PizzaIngredient(
                menu_id=pizzas[8].id, ingredient_id=ingredient_dict["Jalapeños"]
            ),
            # Cheeseburger Pizza
            PizzaIngredient(
                menu_id=pizzas[9].id, ingredient_id=ingredient_dict["Ground Beef"]
            ),
            PizzaIngredient(
                menu_id=pizzas[9].id, ingredient_id=ingredient_dict["Cheddar Cheese"]
            ),
            PizzaIngredient(
                menu_id=pizzas[9].id, ingredient_id=ingredient_dict["Pickles"]
            ),
            PizzaIngredient(
                menu_id=pizzas[9].id, ingredient_id=ingredient_dict["Onions"]
            ),
            # Taco Pizza
            PizzaIngredient(
                menu_id=pizzas[10].id, ingredient_id=ingredient_dict["Ground Beef"]
            ),
            PizzaIngredient(
                menu_id=pizzas[10].id, ingredient_id=ingredient_dict["Cheddar Cheese"]
            ),
            PizzaIngredient(
                menu_id=pizzas[10].id, ingredient_id=ingredient_dict["Lettuce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[10].id, ingredient_id=ingredient_dict["Tomatoes"]
            ),
            # Hawaiian Delight Pizza
            PizzaIngredient(
                menu_id=pizzas[11].id, ingredient_id=ingredient_dict["Tomato Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[11].id, ingredient_id=ingredient_dict["Cheese"]
            ),
            PizzaIngredient(
                menu_id=pizzas[11].id, ingredient_id=ingredient_dict["Ham"]
            ),
            # Caprese Pizza
            PizzaIngredient(
                menu_id=pizzas[12].id, ingredient_id=ingredient_dict["Tomato Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[12].id, ingredient_id=ingredient_dict["Mozzarella"]
            ),
            PizzaIngredient(
                menu_id=pizzas[12].id, ingredient_id=ingredient_dict["Basil"]
            ),
            PizzaIngredient(
                menu_id=pizzas[12].id, ingredient_id=ingredient_dict["Olive Oil"]
            ),
            # Fajita Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[13].id, ingredient_id=ingredient_dict["Chicken"]
            ),
            PizzaIngredient(
                menu_id=pizzas[13].id, ingredient_id=ingredient_dict["Bell Peppers"]
            ),
            PizzaIngredient(
                menu_id=pizzas[13].id, ingredient_id=ingredient_dict["Onions"]
            ),
            PizzaIngredient(
                menu_id=pizzas[13].id, ingredient_id=ingredient_dict["BBQ Sauce"]
            ),
            # Truffle Mushroom Pizza
            PizzaIngredient(
                menu_id=pizzas[14].id, ingredient_id=ingredient_dict["Truffle Oil"]
            ),
            PizzaIngredient(
                menu_id=pizzas[14].id, ingredient_id=ingredient_dict["Mushrooms"]
            ),
            PizzaIngredient(
                menu_id=pizzas[14].id, ingredient_id=ingredient_dict["Garlic"]
            ),
            PizzaIngredient(
                menu_id=pizzas[14].id, ingredient_id=ingredient_dict["Cheese"]
            ),
            # BBQ Pulled Pork Pizza
            PizzaIngredient(
                menu_id=pizzas[15].id, ingredient_id=ingredient_dict["Pulled Pork"]
            ),
            PizzaIngredient(
                menu_id=pizzas[15].id, ingredient_id=ingredient_dict["BBQ Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[15].id, ingredient_id=ingredient_dict["Red Onion"]
            ),
            PizzaIngredient(
                menu_id=pizzas[15].id, ingredient_id=ingredient_dict["Cheddar Cheese"]
            ),
            # Ranch Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[16].id, ingredient_id=ingredient_dict["Chicken"]
            ),
            PizzaIngredient(
                menu_id=pizzas[16].id, ingredient_id=ingredient_dict["Ranch Dressing"]
            ),
            PizzaIngredient(
                menu_id=pizzas[16].id, ingredient_id=ingredient_dict["Cheddar Cheese"]
            ),
            # Cheesy Garlic Pizza
            PizzaIngredient(
                menu_id=pizzas[17].id, ingredient_id=ingredient_dict["Garlic"]
            ),
            PizzaIngredient(
                menu_id=pizzas[17].id, ingredient_id=ingredient_dict["Cheddar Cheese"]
            ),
            PizzaIngredient(
                menu_id=pizzas[17].id, ingredient_id=ingredient_dict["Mozzarella"]
            ),
            # Greek Pizza
            PizzaIngredient(
                menu_id=pizzas[18].id, ingredient_id=ingredient_dict["Feta Cheese"]
            ),
            PizzaIngredient(
                menu_id=pizzas[18].id, ingredient_id=ingredient_dict["Olives"]
            ),
            PizzaIngredient(
                menu_id=pizzas[18].id, ingredient_id=ingredient_dict["Tomato Sauce"]
            ),
            # Spinach and Artichoke Pizza
            PizzaIngredient(
                menu_id=pizzas[19].id, ingredient_id=ingredient_dict["Spinach"]
            ),
            PizzaIngredient(
                menu_id=pizzas[19].id, ingredient_id=ingredient_dict["Artichokes"]
            ),
            PizzaIngredient(
                menu_id=pizzas[19].id, ingredient_id=ingredient_dict["Cheese"]
            ),
            # Sausage and Peppers Pizza
            PizzaIngredient(
                menu_id=pizzas[20].id, ingredient_id=ingredient_dict["Sausage"]
            ),
            PizzaIngredient(
                menu_id=pizzas[20].id, ingredient_id=ingredient_dict["Bell Peppers"]
            ),
            # Veggie Supreme
            PizzaIngredient(
                menu_id=pizzas[21].id, ingredient_id=ingredient_dict["Olives"]
            ),
            PizzaIngredient(
                menu_id=pizzas[21].id, ingredient_id=ingredient_dict["Spinach"]
            ),
            PizzaIngredient(
                menu_id=pizzas[21].id, ingredient_id=ingredient_dict["Mushrooms"]
            ),
            # Wild Mushroom Pizza
            PizzaIngredient(
                menu_id=pizzas[22].id, ingredient_id=ingredient_dict["Mushrooms"]
            ),
            PizzaIngredient(
                menu_id=pizzas[22].id, ingredient_id=ingredient_dict["Truffle Oil"]
            ),
            # Smoky BBQ Veggie
            PizzaIngredient(
                menu_id=pizzas[23].id, ingredient_id=ingredient_dict["BBQ Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[23].id, ingredient_id=ingredient_dict["Veggies"]
            ),
            # Lentil and Spinach Pizza
            PizzaIngredient(
                menu_id=pizzas[24].id, ingredient_id=ingredient_dict["Lentils"]
            ),
            PizzaIngredient(
                menu_id=pizzas[24].id, ingredient_id=ingredient_dict["Spinach"]
            ),
            # Roasted Veggie Pizza
            PizzaIngredient(
                menu_id=pizzas[25].id, ingredient_id=ingredient_dict["Zucchini"]
            ),
            PizzaIngredient(
                menu_id=pizzas[25].id, ingredient_id=ingredient_dict["Olives"]
            ),
            # Pepperoni and Jalapeño
            PizzaIngredient(
                menu_id=pizzas[26].id, ingredient_id=ingredient_dict["Pepperoni"]
            ),
            PizzaIngredient(
                menu_id=pizzas[26].id, ingredient_id=ingredient_dict["Jalapeños"]
            ),
            # Zaatar Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[27].id, ingredient_id=ingredient_dict["Zaatar"]
            ),
            PizzaIngredient(
                menu_id=pizzas[27].id, ingredient_id=ingredient_dict["Chicken"]
            ),
            # Alfredo Shrimp Pizza
            PizzaIngredient(
                menu_id=pizzas[28].id, ingredient_id=ingredient_dict["Shrimp"]
            ),
            PizzaIngredient(
                menu_id=pizzas[28].id, ingredient_id=ingredient_dict["Alfredo Sauce"]
            ),
            # Pesto Veggie Pizza
            PizzaIngredient(
                menu_id=pizzas[29].id, ingredient_id=ingredient_dict["Pesto"]
            ),
            PizzaIngredient(
                menu_id=pizzas[29].id, ingredient_id=ingredient_dict["Veggies"]
            ),
            # Buffalo Veggie Pizza
            PizzaIngredient(
                menu_id=pizzas[30].id, ingredient_id=ingredient_dict["Buffalo Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[30].id, ingredient_id=ingredient_dict["Veggies"]
            ),
            # Sriracha Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[31].id, ingredient_id=ingredient_dict["Chicken"]
            ),
            PizzaIngredient(
                menu_id=pizzas[31].id, ingredient_id=ingredient_dict["Sriracha Sauce"]
            ),
            # Carbonara Pizza
            PizzaIngredient(
                menu_id=pizzas[32].id, ingredient_id=ingredient_dict["Pasta Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[32].id, ingredient_id=ingredient_dict["Pancetta"]
            ),
            # Truffle Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[33].id, ingredient_id=ingredient_dict["Truffle Oil"]
            ),
            PizzaIngredient(
                menu_id=pizzas[33].id, ingredient_id=ingredient_dict["Chicken"]
            ),
            # Ratatouille Pizza
            PizzaIngredient(
                menu_id=pizzas[34].id, ingredient_id=ingredient_dict["Zucchini"]
            ),
            PizzaIngredient(
                menu_id=pizzas[34].id, ingredient_id=ingredient_dict["Eggplant"]
            ),
            # Prawn and Chorizo Pizza
            PizzaIngredient(
                menu_id=pizzas[35].id, ingredient_id=ingredient_dict["Chorizo"]
            ),
            PizzaIngredient(
                menu_id=pizzas[35].id, ingredient_id=ingredient_dict["Prawns"]
            ),
            # Beef Stroganoff Pizza
            PizzaIngredient(
                menu_id=pizzas[36].id, ingredient_id=ingredient_dict["Beef"]
            ),
            PizzaIngredient(
                menu_id=pizzas[36].id, ingredient_id=ingredient_dict["Mushrooms"]
            ),
            # Cajun Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[37].id, ingredient_id=ingredient_dict["Cajun Chicken"]
            ),
            # Mediterranean Lamb Pizza
            PizzaIngredient(
                menu_id=pizzas[38].id, ingredient_id=ingredient_dict["Lamb"]
            ),
            # Garlic and Herb Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[39].id, ingredient_id=ingredient_dict["Garlic"]
            ),
            # Eggplant Parmesan Pizza
            PizzaIngredient(
                menu_id=pizzas[40].id, ingredient_id=ingredient_dict["Eggplant"]
            ),
            # Buffalo Cauliflower Pizza
            PizzaIngredient(
                menu_id=pizzas[41].id, ingredient_id=ingredient_dict["Cauliflower"]
            ),
            # Roasted Garlic Pizza
            PizzaIngredient(
                menu_id=pizzas[42].id, ingredient_id=ingredient_dict["Garlic"]
            ),
            # Prawn Scampi Pizza
            PizzaIngredient(
                menu_id=pizzas[43].id, ingredient_id=ingredient_dict["Prawns"]
            ),
            # Firecracker Chicken Pizza
            PizzaIngredient(
                menu_id=pizzas[44].id,
                ingredient_id=ingredient_dict["Firecracker Sauce"],
            ),
            # Margherita Pizza
            PizzaIngredient(
                menu_id=pizzas[45].id, ingredient_id=ingredient_dict["Tomato Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[45].id, ingredient_id=ingredient_dict["Cheese"]
            ),
            # Pepperoni Pizza
            PizzaIngredient(
                menu_id=pizzas[46].id, ingredient_id=ingredient_dict["Tomato Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[46].id, ingredient_id=ingredient_dict["Pepperoni"]
            ),
            PizzaIngredient(
                menu_id=pizzas[46].id, ingredient_id=ingredient_dict["Cheese"]
            ),
            # Veggie Delight Pizza
            PizzaIngredient(
                menu_id=pizzas[47].id, ingredient_id=ingredient_dict["Tomato Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[47].id, ingredient_id=ingredient_dict["Veggies"]
            ),
            PizzaIngredient(
                menu_id=pizzas[47].id, ingredient_id=ingredient_dict["Cheese"]
            ),
            PizzaIngredient(
                menu_id=pizzas[47].id, ingredient_id=ingredient_dict["Olives"]
            ),
            PizzaIngredient(
                menu_id=pizzas[47].id, ingredient_id=ingredient_dict["Onions"]
            ),
            PizzaIngredient(
                menu_id=pizzas[47].id, ingredient_id=ingredient_dict["Bell Peppers"]
            ),
            # Meat Lovers Pizza
            PizzaIngredient(
                menu_id=pizzas[48].id, ingredient_id=ingredient_dict["Cheese"]
            ),
            PizzaIngredient(
                menu_id=pizzas[48].id, ingredient_id=ingredient_dict["Tomato Sauce"]
            ),
            PizzaIngredient(
                menu_id=pizzas[48].id, ingredient_id=ingredient_dict["Pepperoni"]
            ),
            PizzaIngredient(
                menu_id=pizzas[48].id, ingredient_id=ingredient_dict["Bacon"]
            ),
            PizzaIngredient(
                menu_id=pizzas[48].id, ingredient_id=ingredient_dict["Ham"]
            ),
        ]
    )
    ...
    for dessert_data in desserts_data:
        existing_dessert = (
            session.query(Menu).filter_by(name=dessert_data["name"]).first()
        )
    ...
    discount = [
        {"name": "PIE", "value": 0.314},
        {"name": "HALF", "value": 0.5},
        {"name": "TEN", "value": 0.1},
        {"name": "FIFTEEN", "value": 0.15},
        {"name": "TWENTY", "value": 0.2},
        {"name": "THIRTY", "value": 0.3},
        {"name": "FORTY", "value": 0.4},
        {"name": "FIFTY", "value": 0.5},
        {"name": "SIXTY", "value": 0.6},
        {"name": "SEVENTY", "value": 0.7},
        {"name": "EIGHTY", "value": 0.8},
        {"name": "NINETY", "value": 0.9},
        {"name": "HUNDRED", "value": 1},
        {"name": "G_FORCE", "value": 0.098},
        {"name": "LIGHTSPEED", "value": 0.3},
        {"name": "BOLTZ", "value": 0.138},
        {"name": "PLANCK", "value": 0.663},
        {"name": "EULER", "value": 0.2718},
        {"name": "QUANTUM", "value": 0.42},
    ]

    for discount_data in discount:
        existing_discount = (
            session.query(Discounts).filter_by(name=discount_data["name"]).first()
        )
