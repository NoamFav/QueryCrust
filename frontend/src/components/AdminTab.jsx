                        ...
                        >
                            <div className="flex justify-between items-center">
                                ...
                                <p className="text-gray-700 font-medium">
                                    Total: <span className="text-green-600">{order.total_cost} €</span>
                                </p>
                            </div>
                                        ...
                                        <ul className="pl-4 text-gray-600">
                                            {item.ingredients.map(ingredient => (
                                                <li key={ingredient.name}>
                                                    {ingredient.name} 
                                                    <span className={`text-${ingredient.action === 'add' ? 'green' : 'red'}-500`}>
                            ...
                            <div className="mt-4 flex space-x-2">
                                <button 
                                    ...
                                    onClick={() => handleStatusUpdate(order.order_id, 'In Preparation')}
                                >
                                    In Preparation
                                </button>
                                <button 
                                    className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600"
                                    onClick={() => handleStatusUpdate(order.order_id, 'In Delivery')}
                                >
                                    In Delivery
                                </button>
                                <button 
